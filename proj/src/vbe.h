...
#define MODE_768_256 0x105

#define MODE_200_64K 0x10E // Unused.
#define MODE_480_64K 0x111
#define MODE_600_64K 0x114
#define MODE_768_64K 0x117
#define MODE_1024_64K 0x11A

#define INT_VIDEO_CARD 0x10
#define VBE_FUNC 0x4F
#define SET_VBE_MODE 0x02
#define RET_VBE_INFO 0x01
#define RET_VBE_CONTROLLER 0x00
#define PALETTE_FORMAT 0x08
#define SET_PALETTE_FORMAT 0x00
#define GET_PALETTE_FORMAT 0x01
#define PALETTE_DATA 0x09
#define SET_PALETTE_DATA 0X00
#define GET_PALETTE_DATA 0x01

#define PB2BASE(x) (((x) >> 4) & 0x0F000)
#define PB2OFF(x) ((x) & 0x0FFFF)
#define REAL_TO_PROTECT(addr) (((long) addr) >> 12) + (((long) addr) & 0xFFFF)
 ...
 * @param map address of mmap_t with address of vbe_mode_info_t structure to be initialized
