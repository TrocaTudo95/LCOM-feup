...
/**
 * @brief Waits for n seconds to pass.
 * Works independently of timer being already subscribed or not.
 * @param n Amount of seconds.
 * @return -1 if timer unsubscription failure, OK otherwise.
 */
